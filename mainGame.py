...
class Game:
    def __init__(self):
        ...
        self.room1 = Room([LockedDoor(35,360), Door(700,360), HiddenDoor(300,300)], [], image1,1)
        ...
        self.room7 = Room([LockedDoor(35,360), Door(700,360)], [], image1,7)
        self.room8 = Room([LockedDoor(35,360), Door(700,360)], [], image1,8)
        self.room9 = Room([LockedDoor(35,360), Door(700,360)], [], image1,9)
        self.room10 = Room([LockedDoor(35,360), Door(700,360)], [], image1,10)
        self.hiddenRoom = HiddenRoom([Door(700,360)],[],image1,0)
