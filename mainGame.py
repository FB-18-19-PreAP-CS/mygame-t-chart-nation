...
class Game:
    def __init__(self):
        ...
        self.existingwalls = []
        self.existingItems = []
        self.mob = Enemys(100,420,32,32,600)
        image1 = pygame.image.load('dunegon.png')
        self.room1 = Room([LockedDoor(35,360), Door(700,360), HiddenDoor(300,300)], [], image1,2)
        self.room2 = Room([LockedDoor(35,360), Door(700,360)], [], image1,2)
        self.room3 = Room([LockedDoor(35,360), Door(700,360)], [], image1,2)
        self.room4 = Room([LockedDoor(35,360), Door(700,360)], [], image1,2)
        self.room5 = Room([LockedDoor(35,360), Door(700,360)], [], image1,2)
        self.room6 = Room([LockedDoor(35,360), Door(700,360)], [], image1,2)
        self.room7 = Room([LockedDoor(35,360), Door(700,360)], [], image1,2)
        self.room8 = Room([LockedDoor(35,360), Door(700,360)], [], image1,2)
        self.room9 = Room([LockedDoor(35,360), Door(700,360)], [], image1,2)
        self.room10 = Room([LockedDoor(35,360), Door(700,360)], [], image1,2)
        self.hiddenRoom = HiddenRoom([Door(700,360)],[],image1,2)
    ...
    def spawnEnemies(self, Room):
        for i in range(Room.enemyNumber):
            pass
